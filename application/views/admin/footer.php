    ...
    <footer class="footer footer-static footer-light navbar-border  navbar-fixed-bottom">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">All Rights Reserved by <strong>Vaidik AstroTalk</strong>.<span class="float-md-right d-xs-block d-md-inline-block">Confounding Solution & Made with <i class="icon-heart5 pink"></i></span></p>
    </footer>
