		...
		<div class="container-fluid">
			<div class="row">
				<div class="services_images">
					<img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/services/services_fullpage.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				</div>
				<div class="services_matter">
					<h2 class="wow fadeInDown animated"><a href="">Kundli Dosha</a></h2>
