			...
			<div class="row align-items-center">
				<div class="col-lg-8 col-md-12">
					<ul class="top-header-contact-info">
						<li><i class="fa fa-envelope-o"></i><span ></span> info@yourcompany.com</li>
					...
					<div class="astrology-responsive-menu">
						<div class="logo">
							<a href="<?php echo base_url();?>">
								<img src="<?php echo base_url();?>assets/image/logo/logo.png" alt="logo">
							</a>
						</div>
						...
						<div class="others-option align-items-center">
									<div class="option-item">
										<div class="cart-btn">
											<a href="<?php echo base_url('home/cart');?>"><i class="fa fa-shopping-cart"></i><span>1</span></a>
										</div>
									</div>
