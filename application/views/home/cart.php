				...
				<div class="table-custom-responsive wow fadeInDown animated">
					<table class="table-custom table-cart table-responsive">
						<thead>
							...
							<tbody>
								<tr>
									<td><a class="table-cart-figure" href="checkout.html"><img src="<?php echo base_url();?>assets/image/products/products_07.png" alt="" width="146" height="132"></a><a class="table-cart-link" href="#">Natural Mineral Stone</a></td>
									<td>$125.00</td>
									<td>
								...
								<tr>
									<td><a class="table-cart-figure" href="checkout.html"><img src="<?php echo base_url();?>assets/image/products/products_01.png" alt="" width="146" height="132"></a><a class="table-cart-link" href="#">Natural Agate</a></td>
									<td>$50.00</td>
									<td>
										<div class="table-cart-stepper">
											<div class="stepper "><input class="form-input stepper-input" type="number" data-zeros="true" value="1" min="1" max="1000"><span class="stepper-arrow up"></span><span class="stepper-arrow down"></span></div>
								...
								<tr>
									<td><a class="table-cart-figure" href="checkout.html"><img src="<?php echo base_url();?>assets/image/products/products_02.png" alt="" width="146" height="132"></a><a class="table-cart-link" href="#">Natural Mineral Stone</a></td>
									<td>$125.00</td>
									<td>
										<div class="table-cart-stepper">
											<div class="stepper "><input class="form-input stepper-input" type="number" data-zeros="true" value="1" min="1" max="1000"><span class="stepper-arrow up"></span><span class="stepper-arrow down"></span></div>
