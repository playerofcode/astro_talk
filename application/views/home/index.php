...
<section id="silder" class="silder_wrapper">
	<div id="home-silder" class="owl-carousel owl-theme">
		<div class="item">
			<img src="<?php echo base_url();?>assets/image/silder/slider1.png" width="100%" alt="silder images" title="silder images">
		</div>
		<div class="item">
			<img src="<?php echo base_url();?>assets/image/silder/slider2.png" width="100%" alt="silder images" title="silder images">
		</div>
		<div class="item">
			<img src="<?php echo base_url();?>assets/image/silder/slider3.png" width="100%" alt="silder images" title="silder images">
		</div>
	</div>
</section>
<!-- silder End -->
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="about_text wow slideInLeft">
						...
						<a href="<?php echo base_url('home/about');?>" class="btn">Read More</a>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="about_images wow slideInRight">
						<img src="<?php echo base_url();?>assets/image/about_img.jpg" width="100%" alt="silder images" title="silder images">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated ">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon1.png" alt="icon1">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/aries');?>">Aries</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon2.png" alt="icon2">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/taurus');?>">Taurus</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon3.png" alt="icon3">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/gemini');?>">Gemini</a></h2>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon4.png" alt="icon4">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/cancer');?>">Cancer</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon5.png" alt="icon5">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/leo');?>">leo</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon6.png" alt="icon6">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/virgo');?>">Virgo</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon7.png" alt="icon7">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/libra');?>">Libra</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon8.png" alt="icon8">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/scorpio');?>">Scorpio</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon9.png" alt="icon9">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/sagittairus');?>">Sagittairus</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon10.png" alt="icon10">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/capricorn');?>">Capricorn</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon11.png" alt="icon11">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/aquarius');?>">Aquarius</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?php echo base_url();?>assets/image/rashi/icon12.png" alt="icon12">
					</div>
					<div class="sign_box_cont">
						<h4><a href="<?php echo base_url('home/pisces');?>">Pisces</a></h4>
						<p>30 march 2020</p>
					</div>
				</div>
			</div>
			...
			<?php foreach ($astro_mall_product as $key): ?>
					...
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="<?php echo base_url('home/product_info/'.$key->id);?>"><img class="wow fadeInDown animated" src="<?php echo base_url($key->image);?>" alt="Kundli Dosha" title="<?php echo $key->name;?>" width="100%" height="250px"></a>
							</div>
							<div class="caption">
								...
								<div class="rate-and-title">
									...
									<p class="price wow fadeInDown animated">
										<!-- <span class="price-old">$123.20</span> --> <span class="price-new">Rs <?php echo $key->price;?></span>  
									</p>
									<a href="<?php echo base_url('home/product_info/'.$key->id);?>" class="btn wow fadeInDown animated" onclick="" title="Add to Cart"><span><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
								</div>
							</div>
						</div>
					</div>				
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/products/products_02.png" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/products/products_03.png" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/products/products_07.png" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<!--5 -->	
					<div class="item">
						<div class="col-sm-12">
							<div class="product-thumb">
								<div class="image wow fadeInDown animated">
									<a href="single-products.html"><img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/products/products_01.png" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/services/services3.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/services/services2.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?php echo base_url();?>assets/image/services/services1.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="row">
					<div id="testimonial" class="owl-carousel owl-theme">
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?php echo base_url();?>assets/image/testimonial/1.jpg" class="wow fadeInDown animated">
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?php echo base_url();?>assets/image/testimonial/2.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?php echo base_url();?>assets/image/testimonial/3.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?php echo base_url();?>assets/image/testimonial/4.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
...
<!-- Blog -->
	<div id="blogs" class="blog_section">
		<div class="container-fluid">
			<div class="heading_wrapper wow fadeInDown animated">
				<h2 class="wow fadeInDown animated">latest blogs</h2>
				<p class="wow fadeInDown animated">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text </p>
			</div>
				<div class="row">
